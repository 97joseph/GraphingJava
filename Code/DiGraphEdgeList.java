...
public class DiGraphEdgeList implements DiGraphADT {
     ...
     * @return returns true if the edge was not previously present. Otherwise
     *         returns false.
     */
     ...
     * @return returns an ArrayList of Integers which represent the successor nodes
     *         of the given node
     */
     ...
     * 
     * @param node a node in the graph
     * @return returns an ArrayList of Integers which represent the predecessor
    ...
    /**
     * The ingree of a node in the graph
     * 
     * @param node a node in the graph
